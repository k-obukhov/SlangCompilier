...
namespace SLangCompiler
{
    ...
    static class CompilerConstants
    {
        ...
        public static string[] SlangKeywords => new string[] { "variable", "const", "length", "let", "return", "input", "output", "call", "if", "then", "else", "while", "repeat", "elseif", "do", "raw", "module", "import", "start", "end", "function", "procedure", "integer", "real", "character", "boolean", "string", "unit", "new", "nil", "pointer", "true", "false", "array", "val", "ref", "public", "private", "class", "inherit", "base", "abstract", "override", "raw", "readonly" };
