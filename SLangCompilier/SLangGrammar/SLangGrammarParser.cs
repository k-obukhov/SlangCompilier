...
public partial class SLangGrammarParser : Parser {
	...
	public ArrayDeclTypeContext arrayDeclType() {
		...
		try {
			...
			do {
				{
				{
				State = 158; Match(LSBrace);
				State = 159; exp();
				State = 160; Match(RSBrace);
				}
				}
				State = 164;
				_errHandler.Sync(this);
	...
	public ModuleFieldDeclContext moduleFieldDecl() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 180; Match(AccessModifier);
			State = 182;
			_errHandler.Sync(this);
			_la = _input.La(1);
			if (_la==Readonly) {
				{
				State = 181; Match(Readonly);
				}
			}

			State = 184; variableDecl();
	...
	public ScalarTypeContext scalarType() {
		...
		try {
			...
			case SimpleType:
				EnterOuterAlt(_localctx, 1);
				{
				State = 200; simpleType();
				}
				break;
			case Id:
				EnterOuterAlt(_localctx, 2);
				{
				State = 201; customType();
				}
				break;
			case Pointer:
				EnterOuterAlt(_localctx, 3);
	...
	public ArrayDimentionContext arrayDimention() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 215; Match(LSBrace);
			State = 216; Match(RSBrace);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public TypeDeclContext typeDecl() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 218; Match(AccessModifier);
			State = 220;
			_errHandler.Sync(this);
			_la = _input.La(1);
			if (_la==Base) {
				{
				State = 219; Match(Base);
				}
			}

			State = 222; Match(Class);
			State = 223; Match(Id);
			State = 225;
			_errHandler.Sync(this);
			_la = _input.La(1);
	...
	public TypeInheritContext typeInherit() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 235; Match(Inherit);
			State = 236; Match(LBrace);
			State = 237; customType();
	...
	public TypeFieldDeclContext typeFieldDecl() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 240; Match(AccessModifier);
			State = 241; variableDecl();
	...
	public ThisHeaderContext thisHeader() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 264; Match(LBrace);
			State = 265; customType();
			State = 266; Match(Id);
	...
	public RoutineArgContext routineArg() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 280; Match(FunctionArgModifier);
			State = 281; Match(Id);
			}
		}
		catch (RecognitionException re) {
	...
	public ProcedureDeclContext procedureDecl() {
		...
		try {
			...
			if (_la==LSBrace) {
				{
				State = 283; importHead();
				}
			}

			State = 286; Match(AccessModifier);
			State = 288;
			_errHandler.Sync(this);
			_la = _input.La(1);
			if (_la==Abstract || _la==Override) {
			...
			if (_la==LBrace) {
				{
				State = 290; thisHeader();
				}
			}

			State = 293; Match(Procedure);
			State = 294; Match(LBrace);
			State = 295; routineArgList();
			State = 296; Match(RBrace);
			State = 297; Match(Id);
	...
	public ImportHeadContext importHead() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 301; Match(LSBrace);
			State = 302; Match(File);
			State = 303; Match(StringLiteral);
			State = 304; Match(Import);
			State = 305; Match(StringLiteral);
			State = 306; Match(RSBrace);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public IfCContext ifC() {
		...
		try {
			...
			while (_la==Elseif) {
				{
				{
				State = 344; Match(Elseif);
				State = 345; Match(LBrace);
				State = 346; exp();
				State = 347; Match(RBrace);
				State = 348; Match(Then);
				State = 349; statementSeq();
				}
				}
				State = 355;
				_errHandler.Sync(this);
	...
	public WhileCContext whileC() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 362; Match(While);
			State = 363; Match(LBrace);
			State = 364; exp();
			State = 365; Match(RBrace);
			State = 366; Match(Do);
	...
	public RepeatCContext repeatC() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 370; Match(Repeat);
			State = 371; statementSeq();
			State = 372; Match(While);
			State = 373; Match(LBrace);
			State = 374; exp();
			State = 375; Match(RBrace);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public CallContext call() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 399; Match(Call);
			State = 400; designator();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public ExpContext exp() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 413; simpleExpr();
			State = 416;
			_errHandler.Sync(this);
			_la = _input.La(1);
			if (_la==Relation) {
				{
				State = 414; Match(Relation);
				State = 415; exp();
				}
			}
	...
	public SimpleExprContext simpleExpr() {
		...
		try {
			...
			if (_la==AddictiveOp) {
				{
				State = 419; Match(AddictiveOp);
				State = 420; simpleExpr();
				}
			}
	...
	public TermContext term() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 423; signedFactor();
			State = 426;
			_errHandler.Sync(this);
			_la = _input.La(1);
			if (_la==MultiplicativeOp) {
				{
				State = 424; Match(MultiplicativeOp);
				State = 425; term();
				}
			}
	...
	public NewCContext newC() {
		...
		try {
			...
			{
			State = 444; Match(New);
			State = 445; Match(LBrace);
			State = 446; customType();
	...
	public static readonly string _serializedATN =
		"\x3\xAF6F\x8320\x479D\xB75C\x4880\x1605\x191C\xAB37\x3\x46\x1DD\x4\x2"+
		...
		"\t\x5\t\x93\n\t\x3\t\x3\t\x3\t\x5\t\x98\n\t\x3\n\x3\n\x3\n\x3\n\x5\n\x9E"+
		"\n\n\x3\v\x3\v\x3\v\x3\v\x3\v\x6\v\xA5\n\v\r\v\xE\v\xA6\x3\v\x3\v\x3\f"+
		"\x3\f\x3\f\x3\f\x5\f\xAF\n\f\x3\r\x3\r\x3\r\x3\r\x3\r\x3\r\x3\xE\x3\xE"+
		"\x5\xE\xB9\n\xE\x3\xE\x3\xE\x3\xE\x3\xF\x3\xF\x5\xF\xC0\n\xF\x3\x10\x3"+
		"\x10\x3\x10\x3\x10\x3\x10\x5\x10\xC7\n\x10\x3\x11\x3\x11\x3\x12\x3\x12"+
		"\x3\x12\x5\x12\xCE\n\x12\x3\x13\x3\x13\x3\x14\x3\x14\x6\x14\xD4\n\x14"+
		"\r\x14\xE\x14\xD5\x3\x14\x3\x14\x3\x15\x3\x15\x3\x15\x3\x16\x3\x16\x5"+
		"\x16\xDF\n\x16\x3\x16\x3\x16\x3\x16\x5\x16\xE4\n\x16\x3\x16\a\x16\xE7"+
		"\n\x16\f\x16\xE\x16\xEA\v\x16\x3\x16\x3\x16\x3\x17\x3\x17\x3\x17\x3\x17"+
		"\x3\x17\x3\x18\x3\x18\x3\x18\x3\x18\x3\x19\x5\x19\xF8\n\x19\x3\x19\x3"+
		"\x19\x5\x19\xFC\n\x19\x3\x19\x5\x19\xFF\n\x19\x3\x19\x3\x19\x3\x19\x3"+
		"\x19\x3\x19\x3\x19\x3\x19\x3\x19\x3\x19\x3\x19\x3\x1A\x3\x1A\x3\x1A\x3"+
		"\x1A\x3\x1A\x3\x1B\x3\x1B\x3\x1B\a\x1B\x113\n\x1B\f\x1B\xE\x1B\x116\v"+
		"\x1B\x3\x1B\x5\x1B\x119\n\x1B\x3\x1C\x3\x1C\x3\x1C\x3\x1D\x5\x1D\x11F"+
		"\n\x1D\x3\x1D\x3\x1D\x5\x1D\x123\n\x1D\x3\x1D\x5\x1D\x126\n\x1D\x3\x1D"+
		"\x3\x1D\x3\x1D\x3\x1D\x3\x1D\x3\x1D\x3\x1D\x3\x1D\x3\x1E\x3\x1E\x3\x1E"+
		"\x3\x1E\x3\x1E\x3\x1E\x3\x1E\x3\x1F\a\x1F\x138\n\x1F\f\x1F\xE\x1F\x13B"+
		"\v\x1F\x3 \x3 \x5 \x13F\n \x3!\x3!\x3!\x3!\x3!\x3!\x5!\x147\n!\x3!\x3"+
		"!\x3\"\x3\"\x3\"\x5\"\x14E\n\"\x3#\x3#\x3#\x3#\x3#\x3$\x3$\x3$\x3$\x3"+
		"$\x3$\x3$\x3$\x3$\x3$\x3$\x3$\x3$\a$\x162\n$\f$\xE$\x165\v$\x3$\x3$\x5"+
		"$\x169\n$\x3$\x3$\x3%\x3%\x3%\x3%\x3%\x3%\x3%\x3%\x3&\x3&\x3&\x3&\x3&"+
		"\x3&\x3&\x3\'\x3\'\x3\'\x3\'\a\'\x180\n\'\f\'\xE\'\x183\v\'\x3(\x3(\x3"+
		"(\x3(\a(\x189\n(\f(\xE(\x18C\v(\x3)\x3)\x5)\x190\n)\x3*\x3*\x3*\x3+\x3"+
		"+\x3+\a+\x198\n+\f+\xE+\x19B\v+\x3+\x5+\x19E\n+\x3,\x3,\x3,\x5,\x1A3\n"+
		",\x3-\x3-\x3-\x5-\x1A8\n-\x3.\x3.\x3.\x5.\x1AD\n.\x3/\x5/\x1B0\n/\x3/"+
		"\x3/\x3\x30\x3\x30\x3\x30\x3\x30\x3\x30\x3\x30\x3\x30\x3\x30\x3\x30\x5"+
		"\x30\x1BD\n\x30\x3\x31\x3\x31\x3\x31\x3\x31\x3\x31\x3\x32\x3\x32\a\x32"+
		"\x1C6\n\x32\f\x32\xE\x32\x1C9\v\x32\x3\x33\x3\x33\x3\x33\x3\x33\x3\x33"+
		"\x3\x33\x3\x33\x3\x33\x3\x33\x3\x33\x5\x33\
		"\x147\x148\x3\x2\x2\x2\x148\x149\a\x16\x2\x2\x149\x41\x3\x2\x2\x2\x14A"+
		"\x14E\x5\x46$\x2\x14B\x14E\x5H%\x2\x14C\x14E\x5J&\x2\x14D\x14A\x3\x2\x2"+
		"\x2\x14D\x14B\x3\x2\x2\x2\x14D\x14C\x3\x2\x2\x2\x14E\x43\x3\x2\x2\x2\x14F"+
		"\x150\a\x1B\x2\x2\x150\x151\x5\x62\x32\x2\x151\x152\a\x32\x2\x2\x152\x153"+
		"\x5V,\x2\x153\x45\x3\x2\x2\x2\x154\x155\a!\x2\x2\x155\x156\a.\x2\x2\x156"+
		"\x157\x5V,\x2\x157\x158\a/\x2\x2\x158\x159\a\"\x2\x2\x159\x163\x5<\x1F"+
		"\x2\x15A\x15B\a&\x2\x2\x15B\x15C\a.\x2\x2\x15C\x15D\x5V,\x2\x15D\x15E"+
		"\a/\x2\x2\x15E\x15F\a\"\x2\x2\x15F\x160\x5<\x1F\x2\x160\x162\x3\x2\x2"+
		"\x2\x161\x15A\x3\x2\x2\x2\x162\x165\x3\x2\x2\x2\x163\x161\x3\x2\x2\x2"+
		"\x163\x164\x3\x2\x2\x2\x164\x168\x3\x2\x2\x2\x165\x163\x3\x2\x2\x2\x166"+
		"\x167\a#\x2\x2\x167\x169\x5<\x1F\x2\x168\x166\x3\x2\x2\x2\x168\x169\x3"+
		"\x2\x2\x2\x169\x16A\x3\x2\x2\x2\x16A\x16B\a+\x2\x2\x16BG\x3\x2\x2\x2\x16C"+
		"\x16D\a$\x2\x2\x16D\x16E\a.\x2\x2\x16E\x16F\x5V,\x2\x16F\x170\a/\x2\x2"+
		"\x170\x171\a\'\x2\x2\x171\x172\x5<\x1F\x2\x172\x173\a+\x2\x2\x173I\x3"+
		"\x2\x2\x2\x174\x175\a%\x2\x2\x175\x176\x5<\x1F\x2\x176\x177\a$\x2\x2\x177"+
		"\x178\a.\x2\x2\x178\x179\x5V,\x2\x179\x17A\a/\x2\x2\x17AK\x3\x2\x2\x2"+
		"\x17B\x17C\a\x1D\x2\x2\x17C\x181\x5\x62\x32\x2\x17D\x17E\a\x17\x2\x2\x17E"+
		"\x180\x5\x62\x32\x2\x17F\x17D\x3\x2\x2\x2\x180\x183\x3\x2\x2\x2\x181\x17F"+
		"\x3\x2\x2\x2\x181\x182\x3\x2\x2\x2\x182M\x3\x2\x2\x2\x183\x181\x3\x2\x2"+
		"\x2\x184\x185\a\x1E\x2\x2\x185\x18A\x5V,\x2\x186\x187\a\x17\x2\x2\x187"+
		"\x189\x5V,\x2\x188\x186\x3\x2\x2\x2\x189\x18C\x3\x2\x2\x2\x18A\x188\x3"+
		"\x2\x2\x2\x18A\x18B\x3\x2\x2\x2\x18BO\x3\x2\x2\x2\x18C\x18A\x3\x2\x2\x2"+
		"\x18D\x18F\a\x1C\x2\x2\x18E\x190\x5V,\x2\x18F\x18E\x3\x2\x2\x2\x18F\x190"+
		"\x3\x2\x2\x2\x190Q\x3\x2\x2\x2\x191\x192\a\x1F\x2\x2\x192\x193\x5\x62"+
		"\x32\x2\x193S\x3\x2\x2\x2\x194\x199\x5V,\x2\x195\x196\a\x17\x2\x2\x196"+
		"\x198\x5V,\x2\x197\x195\x3\x2\x2\x2\x198\x19B\x3\x2\x2\x2\x199\x197\x3"+
		"\x2\x2\x2\x199\x19A\x3\x2\x2\x2\x19A\x19E\x3\x2\x2\x2\x19B\x199\x3\x2"+
		"\x2\x2\x19C\x19E\x3\x2\x2\x2\x19D\x194\x3\x2\x2\x2\x19D\x19C\x3\x2\x2"+
		"\x2\x19EU\x3\x2\x2\x2\x19F\x1A2\x5X-\x2\x1A0\x1A1\a\x14\x2\x2\x1A1\x1A3"+
		"\x5V,\x2\x1A2\x1A0\x3\x2\x2\x2\x1A2\x1A3\x3\x2\x2\x2\x1A3W\x3\x2\x2\x2"+
		"\x1A4\x1A7\x5Z.\x2\x1A5\x1A6\a\v\x2\x2\x1A6\x1A8\x5X-\x2\x1A7\x1A5\x3"+
		"\x2\x2\x2\x1A7\x1A8\x3\x2\x2\x2\x1A8Y\x3\x2\x2\x2\x1A9\x1AC\x5\\/\x2\x1AA"+
		"\x1AB\a\f\x2\x2\x1AB\x1AD\x5Z.\x2\x1AC\x1AA\x3\x2\x2\x2\x1AC\x1AD\x3\x2"+
		"\x2\x2\x1AD[\x3\x2\x2\x2\x1AE\x1B0\t\x3\x2\x2\x1AF\x1AE\x3\x2\x2\x2\x1AF"+
		"\x1B0\x3\x2\x2\x2\x1B0\x1B1\x3\x2\x2\x2\x1B1\x1B2\x5^\x30\x2\x1B2]\x3"+
		"\x2\x2\x2\x1B3\x1BD\x5\x62\x32\x2\x1B4\x1BD\t\x4\x2\x2\x1B5\x1B6\a\x13"+
		"\x2\x2\x1B6\x1BD\x5^\x30\x2\x1B7\x1BD\x5`\x31\x2\x1B8\x1B9\a.\x2\x2\x1B9"+
		"\x1BA\x5V,\x2\x1BA\x1BB\a/\x2\x2\x1BB\x1BD\x3\x2\x2\x2\x1BC\x1B3\x3\x2"+
		"\x2\x2\x1BC\x1B4\x3\x2\x2\x2\x1BC\x1B5\x3\x2\x2\x2\x1BC\x1B7\x3\x2\x2"+
		"\x2\x1BC\x1B8\x3\x2\x2\x2\x1BD_\x3\x2\x2\x2\x1BE\x1BF\a\x33\x2\x2\x1BF"+
		"\x1C0\a.\x2\x2\x1C0\x1C1\x5 \x11\x2\x1C1\x1C2\a/\x2\x2\x1C2\x61\x3\x2"+
		...
		"\x2\x2\x1D7\x1D9\a\x18\x2\x2\x1D8\x1D6\x3\x2\x2\x2\x1D8\x1D9\x3\x2\x2"+
		"\x2\x1D9\x1DA\x3\x2\x2\x2\x1DA\x1DB\a\x42\x2\x2\x1DBg\x3\x2\x2\x2\x30"+
		"kw\x81\x83\x88\x8D\x92\x97\x9D\xA6\xAE\xB8\xBF\xC6\xCD\xD5\xDE\xE3\xE8"+
		"\xF7\xFB\xFE\x114\x118\x11E\x122\x125\x139\x13E\x146\x14D\x163\x168\x181"+
		"\x18A\x18F\x199\x19D\x1A2\x1A7\x1AC\x1AF\x1BC\x1C7\x1D4\x1D8";
